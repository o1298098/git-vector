  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_button: "inline-flex size-9 items-center justify-center rounded-md bg-transparent",
        range_start: "rounded-l-md bg-primary text-primary-foreground [&>button]:bg-primary [&>button]:text-primary-foreground [&>button:hover]:bg-primary [&>button:hover]:text-primary-foreground",
        range_end: "rounded-r-md bg-primary text-primary-foreground [&>button]:bg-primary [&>button]:text-primary-foreground [&>button:hover]:bg-primary [&>button:hover]:text-primary-foreground",
        selected:
          "bg-muted text-foreground hover:bg-muted hover:text-foreground focus:bg-transparent focus:text-foreground",
        today: "bg-accent text-accent-foreground",
        outside: "text-muted-foreground opacity-50",
        disabled: "text-muted-foreground opacity-50",
        range_middle:
          "bg-muted text-foreground rounded-none hover:bg-muted hover:text-foreground [&>button]:bg-muted [&>button]:text-foreground [&>button:hover]:bg-muted [&>button:hover]:text-foreground",
        hidden: "invisible",
        ...classNames,
      }}
      components={{
